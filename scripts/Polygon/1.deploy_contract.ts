...
async function main() {
    ...
    const Artifacts = await ethers.getContractFactory("ECRegistryV2Polygon");
    ...
    console.log("npx hardhat verify --network matic --contract contracts/ECRegistryV2Polygon.sol:ECRegistryV2Polygon "+ECRegistry.address);

    const deployment = {
        "name": "ECRegistryV2Polygon",
    ...
    deploymentDataArray.push({
        id: 1,
        name: "Contract Deployment - ECRegistryV2Polygon",
