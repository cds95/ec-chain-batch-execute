...
interface ECRegistryV3Interface extends ethers.utils.Interface {
  functions: {
    "addTrait(tuple[])": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "getTraits", values?: undefined): string;
  encodeFunctionData(
...
export class ECRegistryV3 extends BaseContract {
  ...
  interface: ECRegistryV3Interface;
  ...
  estimateGas: {
    ...
    getTraits(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getTraits(overrides?: CallOverrides): Promise<PopulatedTransaction>;
